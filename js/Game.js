class Game {
  constructor() {
    ...
    //5.adicionar chave como falsa pra vida não acabar rápido
  ...
  start() {
    ...
    //adicionar imagem explosão para o carro 2
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if (index === player.index) {
          ...
          //CHAMADA DAS FUNÇÕES DE COLISÃO DOS OBSTACULOS E CARROS
...
//function com uma condição de colisão com os obstaculos
  ...
  //2.escrever Colisão entre CARROS
